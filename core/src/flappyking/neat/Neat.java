...
import flappyking.neat.data_structures.RandomSelector;
import flappyking.neat.genome.ConnectionGene;
import flappyking.neat.genome.Genome;
import flappyking.neat.genome.NodeGene;
...
public class Neat {
    ...
    private double SURVIVORS = 0.3;

    private double PROBABILITY_MUTATE_LINK = 0.3;
    private double PROBABILITY_MUTATE_NODE = 0.1;
    private double PROBABILITY_MUTATE_WEIGHT_SHIFT = 0.01;
    private double PROBABILITY_MUTATE_WEIGHT_RANDOM= 0.01;
